...
@section('title', 'Edit Article - DevBlog')
...
<div class="min-h-screen bg-gradient-to-b from-stone-50 to-white">
    <div class="max-w-3xl mx-auto px-6 py-12">
        <div class="mb-8">
            ...
            <h1 class="font-display text-4xl font-bold text-stone-900">Edit Article</h1>
            <p class="text-stone-600 mt-1">Modify and update your article</p>
        </div>
